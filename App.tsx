...
const App: React.FC = () => {
    ...
    // ⚠️ Rules of Hooks: useEnterpriseAuth MUST be called here, before any early returns.
    // Calling it conditionally (after a return) causes React to throw during state transitions.
    // `organization` is used below for the pending-approval guard rail.
    const { organization } = useEnterpriseAuth()
