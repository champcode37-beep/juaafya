...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
    ...
    // REMOVED: Duplicate user sync logic
    // User syncing is now handled by AppLayout.tsx to prevent race conditions
    // The AppLayout component will sync the user to store when it's ready
